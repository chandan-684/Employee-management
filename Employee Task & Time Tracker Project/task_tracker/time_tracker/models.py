...
class EmployeeProfile(models.Model):
    ...
    job_role = models.ForeignKey(JobRole, on_delete=models.PROTECT, blank=True, null=True)
    department = models.ForeignKey(Department, on_delete=models.PROTECT, blank=True, null=True)
    line_manager = models.ForeignKey(User, on_delete=models.PROTECT, blank=True, null=True,related_name="%(app_label)s_%(class)s_line_manager")
...
class Timesheet(models.Model):
    ...
    employee = models.ForeignKey(User, on_delete=models.DO_NOTHING, related_name="%(app_label)s_%(class)s_employee")
    recorded_by = models.ForeignKey(User, on_delete=models.DO_NOTHING, related_name="%(app_label)s_%(class)s_recorded_by")   
